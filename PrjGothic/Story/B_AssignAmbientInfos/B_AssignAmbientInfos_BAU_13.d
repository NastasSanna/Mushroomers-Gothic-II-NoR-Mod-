...
func void DIA_BAU_13_HowAU_Info()
{
	...
	if (rnd == 0)	{
		AI_Output(self,other,"DIA_BAU_HowAU_13_01");	//Грех жаловаться. Урожай в этом году хороший.
	} else if (rnd == 1)	{
		AI_Output(self,other,"DIA_BAU_HowAU_13_02");	//Урожай собран, можно ненадолго расслабиться.
	} else	{
		AI_Output(self,other,"DIA_BAU_HowAU_13_03");	//Спина ноет, а так, все, слава Инносу, в порядке.
	};
};
...
func void DIA_BAU_13_News_Info()
{
	...
	if (rnd == 0)	{
		AI_Output(self,other,"DIA_BAU_News_13_01");	//Да ничего...
	} else	{
		AI_Output(self,other,"DIA_BAU_News_13_02");	//Все как обычно.
	};
};
