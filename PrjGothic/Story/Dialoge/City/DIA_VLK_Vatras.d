...
func void DIA_Vatras_Erol_GoldPlate_Info()
{
	...
	AI_Wait(self, 1.5);
	AI_UseItemToState(self,ItWr_Stoneplate_Gold,-1);
	AI_Output(self,other,"DIA_Vatras_Erol_GoldPlate_05_06");	//Мне потребуется больше времени, чтобы понять ее полностью, но в целом здесь идет речь о неком великом целителе.
	AI_Output(self,other,"DIA_Vatras_Erol_GoldPlate_05_07");	//Возможно, он был похоронен на том кладбище.
