...
{
	if(HasFlags(Npc_GetTalentSkill(other,NPC_TALENT_PICKPOCKET),1) && (self.aivar[AIV_PlayerHasPickedMyPocket] == FALSE)
		&& (other.attribute[ATR_DEXTERITY] >= (TheftDex - Theftdiff)) && (NpcObsessedByDMT == FALSE))
	{
