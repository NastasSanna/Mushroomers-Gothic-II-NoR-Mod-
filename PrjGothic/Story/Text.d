...
const string MOBNAME_Chest_My = "Мой сундук";
const string MOBNAME_Chest_Elena = "Сундук Елены";
const string MOBNAME_Chest_Talbin = "Сундук Талбина";
const string MOBNAME_Chest_Engrom = "Сундук Энгрома";
const string MOBNAME_Chest_Fellan = "Сундук Феллана";
	const string MOBNAME_Chest_Fellan_Full = "Сундук Феллана";
const string MOBNAME_GRAVE = "";
const string MOBNAME_REPORT = "Протокол";
const string MOBNAME_COURTCASE = "Судебное дело";

const string MOBNAME_Istar = "!sTaR";
const string MOBNAME_2Khaos = "2Khaos";
const string MOBNAME_Adept = "Adept";
const string MOBNAME_HelenDream = "Helen Dream";
const string MOBNAME_Kertax = "Kertax";
const string MOBNAME_Naja = "Naja";
const string MOBNAME_Taja = "Taja";
const string MOBNAME_GorNaDrak = "Гор На Драк";
const string MOBNAME_DenisSeregin = "Dennis";
const string MOBNAME_IdolKadar = "Идол Кадар";
const string MOBNAME_MaksimSuhochev = "Максим Сухочев";
const string MOBNAME_NaemnikIzGotiki = "Наемник из Готики";
...
const string MOBNAME_FireCamp = "Костер";
const string MOBNAME_WaterSource = "Источник";
const string MOBNAME_WSWELL = "Колодец";
const string MOBNAME_WSSPRING = "Родник";
const string MOBNAME_WSCLEAR = "Чистая вода";
const string MOBNAME_WSWATER = "Вода";
...
const string MOBNAME_ADANOS = "Статуя Аданоса";
const string MOBNAME_BELIAR = "Статуя Белиара";
const string MOBNAME_RUNEMAKER = "Рунный стол";
const string MOBNAME_SAW = "Бревно";
...
const string MOBNAME_MR_WhiteWolfTrace = "Волчьи следы";
const string MOBNAME_MR_WhiteWolfFur = "Клок белой шерсти";
...
const string TXT_TALENTS_SKILLS[22] =
{
	...
	"-|Изучено",
	"-|Изучено",
	"-|Новичок|Любитель|Мастер",
	"-|Мало|Несколько|Много|Все",
	"-|Изучено",
	"Средне|Мало|Много",
	"Средняя|Очень низкая|Низкая|Высокая|Очень высокая|Невозможная",
	"ПЕРСОНАЖ|ЕЛЕНА|ЭРОЛ|ОДО|РУПЕРТ|САРА|ТАЛБИН|ТИЛЛ",
	"-|Иннос|Аданос|Белиар"
};
...
const string NAME_Miliz = "Стражник";
...
const string PRINT_Trade_Not_Enough_Gold = "Недостаточно золота для покупки этого предмета.";
const string NAME_Value = "Цена: ";
const string NAME_ValueUnknown = "Цена неизвестна";
...
const string NAME_Dam_Edge = "Урон лезвием";
...
const string NAME_Prot_EdgePoint = "Защита от оружия/стрел:";
const string NAME_Prot_Fire = "Защита от огня:";
const string NAME_Prot_Magic = "Защита от магии:";
const string NAME_Prot_FireMagic = "Защита от огня/магии:";
...
const string PRINT_Gold1 = " золотой";
const string PRINT_Gold = " золотых";
const string PRINT_Items = " шт.";
...
const string PRINT_ItemErhalten = "Получен предмет";
...
const string PRINT_Found = "Найдено ";
...
const string PRINT_Raise1H = "Одноручное оружие +";
const string PRINT_Raise2H = "Двуручное оружие";
const string PRINT_RaiseBow = "Лук +";
const string PRINT_RaiseCBow = "Арбалет +";
const string PRINT_Raise_Limit = "(достигнут максимум)";
...
const string PRINT_Addon_AcrobatBonus = "Мое тело стало более гибким и легким.";
const string PRINT_Addon_AcrobatDebonus = "Мое тело теряет подвижность.";
...
const string PRINT_LearnAlchemy = "Изучено: Искусство приготовления зелий";
	const string PRINT_LearnAlchemy_Health_01 = "Изучено: Приготовление лечебной эссенции";
	const string PRINT_LearnAlchemy_Health_02 = "Изучено: Приготовление лечебного экстракта";
	const string PRINT_LearnAlchemy_Health_03 = "Изучено: Приготовление лечебного эликсира";
	const string PRINT_LearnAlchemy_Mana_01 = "Изучено: Приготовление эссенции маны";
	const string PRINT_LearnAlchemy_Mana_02 = "Изучено: Приготовление экстракта маны";
	const string PRINT_LearnAlchemy_Mana_03 = "Изучено: Приготовление эликсира маны";
	const string PRINT_LearnAlchemy_Speed = "Изучено: Приготовление зелья ускорения";
	const string PRINT_LearnAlchemy_Perm_STR = "Изучено: Приготовление эликсира силы";
	const string PRINT_LearnAlchemy_Perm_DEX = "Изучено: Приготовление эликсира ловкости";
	const string PRINT_LearnAlchemy_Perm_Health = "Изучено: Приготовление эликсира жизни";
	const string PRINT_LearnAlchemy_Perm_Mana = "Изучено: Приготовление эликсира духа";
...
const string PRINT_NoInnosTears = "Не хватает 'Слез Инноса'.";
...
const string PRINT_NOTHINGTOGET = "Пусто...";
...
const string Print_BlessDrunk = "Иннос слышит тебя и отрезвляет твой разум.";
...
const string PRINT_FullyHealed = "Раны полностью исцелены.";
const string PRINT_Eat1 = "Я чувствую себя освеженным.";
const string PRINT_Eat2 = "Сочная и свежая пища.";
const string PRINT_Eat3 = "Я чувствую, как меня наполняют силы!";
const string PRINT_EatFish = "Рыба полезна для мозга.";
const string Print_ReadAstronomy = "Меня наполняет чувство божественного просвещения.";
...
const string PRINT_OrcEliteRingEquip = "Я чувствую слабость.";
const string PRINT_SCIsObsessed = "Я чувствую удушье!";
const string PRINT_ClearSCObsession = "Я чувствую себя освобожденным!";
...
const string PRINT_LogEntryFailed = "Задание провалено";
const string PRINT_LogEntrySuccess = "Задание выполнено";
...
const string PRINT_Addon_SCIsWearingRangerRing = "Теперь я ношу знак 'Кольца Воды'";
...
const string DIA_Pickpocket_Nothing		= "Здесь больше нечего ловить.";
const string DIA_Pickpocket_Gold		= "Украсть золото";
const string DIA_Pickpocket_Pocket		= "Украсть кошелек";
const string DIA_Pickpocket_Ring		= "Украсть кольцо";
const string DIA_Pickpocket_Key			= "Украсть ключ";
const string DIA_Pickpocket_Nugget		= "Украсть кусок руды";
const string DIA_Difficulty_Easiest		= "легче легкого";
const string DIA_Difficulty_Easy		= "легко";
const string DIA_Difficulty_Risky		= "рискованно";
const string DIA_Difficulty_Hard		= "довольно трудно";
const string DIA_Difficulty_VeryHard	= "чертовски трудно";
const string DIA_Difficulty_Impossible	= "практически невозможно";

const string NAME_Armor_Ragged = "Изношено. Не мешал бы ремонт.";
const string NAME_Armor_DoubleRagged = "Эта вещь сильно потрепана.";
const string NAME_Armor_DoubleRaggedDestSoon = " Может совсем развалиться.";
const string NAME_Edge_Unsharpen = "Нужно заточить.";
const string NAME_Bow_Nostring = "Без тетивы.";
const string PRINT_Clothes_Ragged = "Эту одежду нужно зашить.";
const string PRINT_Clothes_Ragged2 = "Кажется, что-то порвалось...";
const string PRINT_Clothes_DoubleRagged = "Эта вещь уже превратилась в лохмотья.";
const string PRINT_Clothes_Destroyed = "Это рванье больше нельзя носить!";
const string PRINT_Armor_Ragged = "Этот доспех стоит отремонтировать.";
const string PRINT_Armor_Ragged2 = "Доспехи порядком истрепались.";
const string PRINT_Armor_DoubleRagged = "Этот доспех больше похож на решето...";
const string PRINT_Armor_Destroyed = "Эти доспехи больше ни на что не годятся!";
const string PRINT_Armor_Feminine = "Это женское! Я не могу его надеть.";
const string PRINT_Edge_Unsharpen = "Лезвие пора заточить...";
const string PRINT_Edge_Unsharpen2 = "Лезвие затупилось.";
const string PRINT_EdgeTip_Unsharpen = "Острие затупилось.";
const string PRINT_Tear_String = "Тетива порвалась!";
const string PRINT_Replace_String = "Нужна новая тетива.";
const string PRINT_Weapon_Destroyed = "Оружие не выдержало!";
const string PRINT_Weapon_Destroyed2 = "Хрусть - и пополам...";
const string PRINT_NoRepair = "Отремонтировать не получится...";
const string PRINT_NoString = "У меня нет подходящей тетивы.";
const string PRINT_UnequipBeforeRepair = "Нужно снять, прежде чем ремонтировать.";
const string PRINT_UnequipBeforeRepair2 = "Я не могу это починить прямо на себе!";

const string PRINT_Experience = "Опытность: ";
const string PRINT_ChanceWin = "Вероятность успеха: ";
const string PRINT_ChanceLoose = "Вероятность неудачи: ";

const string PRINT_NotNow1 = "Может быть, позже.";
const string PRINT_NotNow2 = "Я сейчас не в состоянии сделать это.";
const string PRINT_NotNow3 = "Слишком рисковано.";
const string PRINT_CantConcentrateOn1 = "Не могу сосредоточиться, слишком устал.";
const string PRINT_CantConcentrateOn2 = "Я недостаточно сконцентрирован.";
const string PRINT_CantConcentrateOn3 = "Сейчас это слишком сложно для меня.";
const string PRINT_CantLearn1 = "Я сейчас не в состоянии вникать во что-либо.";
const string PRINT_CantLearn2 = "Ничего не понимаю...";
const string PRINT_TryAgain1 = "Не получилось. Попробуем еще раз.";
const string PRINT_TryAgain2 = "Неудачная попытка. Начнем с начала.";
const string PRINT_TryAgain3 = "Что-то пошло не так. Еще разок...";
const string PRINT_WHATFOR1 = "Я не знаю, как это использовать.";
const string PRINT_WHATFOR2 = "И что с этим делать?";
const string PRINT_WHATFOR3 = "А для чего это вообще?";
const string PRINT_BurntSelf = "Обжегся! Эта одежда не годится для работы с огнем.";

const string PRINT_NoSmithTalent = "Я не умею ковать.";
const string PRINT_NoRunesTalent = "Я не умею создавать руны.";
const string PRINT_NoKeilerJawTalent = "Я не умею извлекать клыки кабана из челюсти.";
const string PRINT_MissingSwordRawHot = "Нужна раскаленная заготовка.";
const string PRINT_MissingSmithMace = "Нужен кузнечный молот.";
const string PRINT_MissingRuneBlank = "У меня нет чистого рунного камня.";
const string PRINT_MissingPliers = "Нужны щипцы.";
const string PRINT_MissingPan = "У меня нет сковороды.";
const string PRINT_MissingMuttonRaw = "Нужно сырое мясо для жарки.";
const string PRINT_MissingKnife = "Мне нужен острый нож или кинжал.";
const string PRINT_MissingBowl = "У меня нет миски.";
const string PRINT_MissingPlate = "У меня нет тарелки.";
const string PRINT_MissingScoop = "Где моя большая ложка?";

const string PRINT_Ready = "Готово!";
const string PRINT_DontNeedThis = "Мне это не нужно.";
const string PRINT_DontNeedThisMore = "Мне это больше не нужно.";

const string PRINT_RefuseEat = "Я не буду это есть!";
const string PRINT_RefuseEat2 = "Не стоит это есть...";

const string PRINT_SleepOver = "Я хорошо выспался и отдохнул!";
const string PRINT_SleepOver_Female = "Я хорошо выспалась и отдохнула!";
const string PRINT_SleepMore = "Еще бы поспать...";
const string PRINT_SleepOverObsessed = "Меня всю ночь мучили кошмары.";
const string PRINT_SleepCold = "Мне не удалось выспаться - здесь слишком холодно.";
const string PRINT_SleepPain = "А?! Что? Больно!";
...
const int YPOS_LevelUp		= 25;
const int YPOS_RaiseAttr	= 42;
const int YPOS_RaiseFTal	= 50;
const int YPOS_GoldGiven	= 40;
const int YPOS_GoldTaken	= 45;
const int YPOS_ItemGiven	= 40;
const int YPOS_ItemTaken	= 55;

const int YPOS_RaiseProt	= 52;

const int XPOS_PrintArmor = -1;
const int YPOS_PrintArmor = 15;

const int XPOS_WeaponBroken = -1;
const int YPOS_WeaponBroken = 12;

const int YPOS_TryAgain = 15;

const int XPOS_Needs = 1;
const int YPOS_Needs = 2;

const int XPOS_Hitpoints = 1;
const int YPOS_Hitpoints = 90;

const int YPOS_MobInteract = 70;

const int XPOS_InInventory = -1;
const int YPOS_InInventory = 12;

const int XPOS_Left		= 3;
...
// ГРИБНИКИ
const string NAME_NoValue = "Цена: 0";
const string PRINT_MushroomsAreSpawned = "Выполняется засев грибов.";
const string PRINT_PleaseWait = "Пожалуйста, подождите...";

const string PRINT_Closed1 = "Заперто...";
const string PRINT_Closed2 = "Закрыто на ключ.";

const string PRINT_ChoosePlayer = "Выбор персонажа";

const string PRINT_GOD_Innos_Support = "Иннос дарует свою поддержку!";
const string PRINT_GOD_Innos_Left = "Иннос оставил тебя.";
const string PRINT_GOD_Innos_Rage = "Иннос рассержен!";
const string PRINT_GOD_Beliar_Support = "Белиар слышит твои мольбы!";
const string PRINT_GOD_Beliar_Left = "Белиар отвернулся от тебя.";
const string PRINT_GOD_Beliar_Rage = "Белиар гневается!";
const string PRINT_GOD_Adanos_Support = "Благословение Аданоса пребудет с тобой!";
const string PRINT_GOD_Adanos_Left = "Дабы сохранить равновесие,";
const string PRINT_GOD_Adanos_Left2 = "Аданос лишает тебя своей поддержки.";

const string PRINT_GOD_Adanos_Bless4Good = "Аданос благославляет тебя за благое деяние.";

const string PRINT_Fishers_Rain1 = "И правда, погода испортилась...";
const string PRINT_Fishers_Rain2 = "Фарим не ошибся.";

const string PRINT_WhereAmI = "Где я?..";

const string PRINT_ColdWater = "Вода ледяная!";
const string PRINT_Freezing = "Замерзаю!";
const string PRINT_ColdNoArmor = "Брр... Холодно!";

const string PRINT_Grimbald_FarAway = "Теперь надо продержаться 5 минут.";
const string PRINT_Grimbald_Returned = "Достаточно. Гримбальд уже должен был вернуться.";

const string PRINT_NothingHappens = "Ничего не происходит.";

const string PRINT_RaiseProt = "Мое тело стало менее восприимчивым ";
const string PRINT_RaiseProt_To = "к ";
const string PRINT_RaiseProt_Blunt = "ударам";
const string PRINT_RaiseProt_Edge = "оружию";
const string PRINT_RaiseProt_Point = "стрелам";
const string PRINT_RaiseProt_Magic = "магии";
const string PRINT_RaiseProt_Fire = "огню";

const string NAME_Summon = "Призвать...";
const string NAME_Summon_Demon = "демона";
const string NAME_Summon_Skeleton = "скелет";
const string NAME_Summon_Zombie = "зомби";
const string NAME_Summon_GobboSkeleton = "скелет гоблина";

const string PRINT_Mana_Costen = "ед. маны";
const string PRINT_HP_Costen = "ед. здоровья";
const string PRINT_NotEnoughHP = "Недостаточно здоровья!";
const string PRINT_NotEnoughMana = "Недостаточно маны!";

const string PRINT_KeilerJawBig = "Ого! Таких крупных я давно не видел!";
const string PRINT_DrunkSmell = "Откуда так перегаром несет?";
const string PRINT_SomePleasure = "Прошло несколько очень приятных,";
const string PRINT_SomePleasure2 = "но совершенно бесполезных часов...";

const string PRINT_SomeTimeLater = "Спустя некоторое время...";
