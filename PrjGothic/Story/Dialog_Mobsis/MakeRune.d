...
func void makerune_s1()
{
	...
	{
		PC_MakeRune_End.npc = Hlp_GetInstanceID(self);
		PC_Circle_01.npc = Hlp_GetInstanceID(self);
		PC_Circle_02.npc = Hlp_GetInstanceID(self);
		PC_Circle_03.npc = Hlp_GetInstanceID(self);
		PC_Circle_04.npc = Hlp_GetInstanceID(self);
		PC_Circle_05.npc = Hlp_GetInstanceID(self);
		PC_Circle_06.npc = Hlp_GetInstanceID(self);
		PC_SPL_MasterOfDisaster.npc = Hlp_GetInstanceID(self);
		PC_SPL_PalTeleportSecret.npc = Hlp_GetInstanceID(self);
