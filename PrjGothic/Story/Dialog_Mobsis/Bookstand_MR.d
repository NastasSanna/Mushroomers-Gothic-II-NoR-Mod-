...
func void Use_Shipbuilding_S1()
{
	if(Npc_IsPlayer(self))
	{
		...
		Doc_PrintLines(nDocID,0,"Прежде чем браться за строительство морского судна, надлежит подробно рассчитать его размеры и соотношение частей, а также подобрать и подготовить древесину.");
