...
func void Use_Shipbuilding_S1()
{
	if(Npc_IsPlayer(self))
	{
		...
		Doc_PrintLines(nDocID,1,"Для шпангоутов же, бимсов и обшивки лучше брать брусья и доски из тщательно высушенной древесины горной сосны, срубленной во время зимних холодов. Из нее же надлежит делать и мачты, хотя для них подойдет и орочий бук.");
		Doc_Show(nDocID);
