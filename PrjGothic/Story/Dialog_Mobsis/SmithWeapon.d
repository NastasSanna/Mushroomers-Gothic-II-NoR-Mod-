...
func void smithweapon_s1()
{
	if(Npc_IsPlayer(self))
	{
		...
		PC_SmithWeapon_End.npc = Hlp_GetInstanceID(self);
		PC_Common.npc = Hlp_GetInstanceID(self);
		PC_CommonBACK.npc = Hlp_GetInstanceID(self);
		PC_Ore.npc = Hlp_GetInstanceID(self);
		PC_OreBACK.npc = Hlp_GetInstanceID(self);
		PC_ItMw_1H_Common.npc = Hlp_GetInstanceID(self);
		PC_ItMw_1H_Special_01.npc = Hlp_GetInstanceID(self);
		PC_ItMw_2H_Special_01.npc = Hlp_GetInstanceID(self);
		PC_ItMw_1H_Special_02.npc = Hlp_GetInstanceID(self);
		PC_ItMw_2H_Special_02.npc = Hlp_GetInstanceID(self);
		PC_ItMw_1H_Special_03.npc = Hlp_GetInstanceID(self);
		PC_ItMw_2H_Special_03.npc = Hlp_GetInstanceID(self);
		PC_ItMw_1H_Special_04.npc = Hlp_GetInstanceID(self);
		PC_ItMw_2H_Special_04.npc = Hlp_GetInstanceID(self);
		PC_WEAPON_1H_Harad_01.npc = Hlp_GetInstanceID(self);
		PC_WEAPON_1H_Harad_02.npc = Hlp_GetInstanceID(self);
		PC_WEAPON_1H_Harad_03.npc = Hlp_GetInstanceID(self);
		PC_WEAPON_1H_Harad_04.npc = Hlp_GetInstanceID(self);
