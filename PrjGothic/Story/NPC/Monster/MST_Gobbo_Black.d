/**************************************************************************
	...
	Сильный, но не вооруженный гоблин.
	Трофеи: случайно.
...
instance Gobbo_Black_Till_1(Mst_Default_Gobbo_Black)
{
	B_SetVisuals_Gobbo_Black();
	Npc_SetToFightMode(self,ItMw_1h_Bau_Mace);
};

instance Gobbo_Black_Till_2(Mst_Default_Gobbo_Black)
{
	B_SetVisuals_Gobbo_Black();
	Npc_SetToFightMode(self,ItMw_1h_Bau_Mace);
};

instance Gobbo_Black_Till_3(Mst_Default_Gobbo_Black)
{
	B_SetVisuals_Gobbo_Black();
	Npc_SetToFightMode(self,ItMw_1h_Bau_Mace);
};
