/**************************************************************************
	...
	Ползун.
	Трофеи: мандибулы краулера (жвала ползуна), панцирь краулера
	(панцирные пластины).
	
	Квестовые: в золотой шахте.
...
instance Minecrawler(Mst_Default_Minecrawler)
{
	...
	CreateInvItems(self,ItAt_CrawlerMandibles,1);
	CreateInvItems(self,ItAt_CrawlerPlate,1);
};
