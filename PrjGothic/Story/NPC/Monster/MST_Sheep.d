/**************************************************************************
	...
	Квестовые: овцы старого пастуха.
...
{
	name[0] = "Овца";
	aivar[AIV_StoryFlags] = STORY_Sheep;
	B_SetVisuals_Sheep();
	Npc_SetToFistMode(self);
	aivar[AIV_MM_RoamStart] = OnlyRoutine;
...
instance Sheep_OldShepherd(Mst_Default_Sheep)
{
	B_SetVisuals_Sheep();
	Npc_SetToFistMode(self);
	start_aistate = ZS_MM_AllScheduler;
...
// овцы Малета
instance Sheep_Maleth(Mst_Default_Sheep)
{
	B_SetVisuals_Sheep();
	Npc_SetToFistMode(self);
	start_aistate = ZS_MM_AllScheduler;
...
instance Hammel_Maleth(Mst_Default_Sheep)
{
	name[0] = "Баран";
	B_SetVisuals_Hammel();
	Npc_SetToFistMode(self);
...
instance Sheep_Monastery(Mst_Default_Sheep)
{
	B_SetVisuals_Sheep();
	Npc_SetToFistMode(self);
	start_aistate = ZS_MM_AllScheduler;
