...
func int B_TeachPlayerTalentSmith(var C_Npc slf,var C_Npc oth,var int waffe)
{
	...
	B_LogEntry(TOPIC_TalentSmith,"„тобы выковать оружие, прежде всего мне нужна сыра€ сталь. я должен докрасна нагреть ее в огне кузнечного горна, а затем придать форму на наковальне. ќсобое оружие зачастую требует особых материалов, придающих оружию особые свойства.  овка более совершенного оружи€ требует большей ловкости и опытности в кузнечном деле.");
	if(waffe == WEAPON_Common)
	{
		PLAYER_TALENT_SMITH[WEAPON_Common] = TRUE;
		B_LogEntry(TOPIC_TalentSmith,"ƒл€ простого меча мне не нужно никаких ингредиентов.");
	};
