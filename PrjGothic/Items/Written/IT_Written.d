...
//ItWr_Book_02_01 - простая коричневая
//ItWr_Book_02_02 - коричневая с узором
//ItWr_Book_02_03 - красная
//ItWr_Book_02_04 - синяя
//ItWr_Book_02_05 - фиолетовая
...
instance ItWr_Map_NewWorld(C_Item)
{
	...
	description = "Карта земель Хориниса";
	text[0] = "";
	text[1] = "";
	text[5] = NAME_Value;
	count[5] = value;
...
instance ItWr_Map_NewWorld_City(C_Item)
{
	...
	description = "Карта города Хоринис";
	text[0] = "";
	text[1] = "";
	text[5] = NAME_Value;
	count[5] = value;
...
instance ItWr_Map_OldWorld(C_Item)
{
	...
	description = "Карта долины рудников";
	text[0] = "";
	text[1] = "";
	text[5] = NAME_Value;
	count[5] = value;
