...
func void Use_Letter_Dikar()
{
	if (Npc_IsPlayer(self))	{
		...
		Doc_PrintLine(nDocID,0,"");
		Doc_PrintLines(nDocID,0,"Меня сейчас нет дома, но в моем скромном жилище ты можешь переждать ненастье, укрыться от опасности и дождаться утра. Располагайся поудобнее и не стесняйся.");
		Doc_PrintLine(nDocID,0,"");
