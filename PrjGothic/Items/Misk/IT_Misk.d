...
instance ItMiSwordraw(P_ItMiSword)
{
	name = "Сырая сталь";
	damage[DAM_INDEX_BLUNT] = 20;
	damagetype = DAM_BLUNT;
	range = Range_Common1;
	value = Value_SwordRaw;
	visual = "ItMiSwordraw.3DS";
	description = name;
	count[2] = damage[DAM_INDEX_BLUNT];
	count[5] = value;
};

instance ItMiSwordrawhot(P_ItMiSword)
{
...
prototype P_ItMiSwordBlade(C_ITEM)
{
	mainflag = ITEM_KAT_NONE;
	flags = ITEM_MULTI;
	material = MAT_METAL;
...
instance ItMiSwordbladehot(P_ItMiSwordBlade)
{
...
instance ItMiSwordblade(P_ItMiSwordBlade)
{
	name = "Клинок";
