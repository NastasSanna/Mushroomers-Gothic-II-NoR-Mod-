...
const int VALUE_ITAR_VlkBabe_L = 120;
const int VALUE_ITAR_VlkBabe_M = 150;
const int VALUE_ITAR_VlkBabe_H = 200;
...
const int VALUE_ITAR_BauBabe_L = 90;
const int VALUE_ITAR_BauBabe_M = 110;
...
{
	name = "Роскошный дублет";//"Дублет губернатора";
...
{
	name = "Простая городская одежда";//"Одежда горожанина";
	mainflag = ITEM_KAT_ARMOR;
	flags = 0;
	protection[PROT_EDGE] = 10;
	protection[PROT_BLUNT] = 10;
...
{
	name = "Хорошая городская одежда";//"Одежда горожанина";
	mainflag = ITEM_KAT_ARMOR;
	flags = 0;
	protection[PROT_EDGE] = 10;
	protection[PROT_BLUNT] = 10;
...
{
	name = "Добротный городской костюм";//"Одежда горожанина";
	mainflag = ITEM_KAT_ARMOR;
	flags = 0;
	protection[PROT_EDGE] = 10;
	protection[PROT_BLUNT] = 10;
...
instance ITAR_VlkBabe_L(C_Item)
{
	...
	text[5] = NAME_Value;
	count[5] = value;
	on_equip = Equip_CantSneak;
	on_unequip = Unequip_CantSneak;
};
...
{
	SetMilBeltBonus(TRUE, SldBelt_Equipped); 
};

func void UnEquip_ITAR_MIL_L()
{
	SetMilBeltBonus(FALSE, MilBelt_Equipped);
};
...
{
	SetMilBeltBonus(TRUE, MilBelt_Equipped);
};
...
func void Equip_CantSneak()
{
	if (Npc_IsPlayer(self))	{
		Npc_SetTalentSkill(other,NPC_TALENT_SNEAK,Hero_CanSneak);
	};
};
func void Unequip_CantSneak()
{
	if (Npc_IsPlayer(self))	{
...
{
	SetSldBeltBonus(TRUE, SldBelt_Equipped);
};

func void UnEquip_ITAR_SLD_L()
{
	SetSldBeltBonus(FALSE, SldBelt_Equipped);
};
...
{
	SetMCBeltBonus(TRUE, MCBelt_Equipped);
};

func void UnEquip_ITAR_DJG_Crawler()
{
	SetMCBeltBonus(FALSE, MCBelt_Equipped);
};
...
{
	SetNovBeltBonus(TRUE, NovBelt_Equipped);
};

func void UnEquip_ITAR_NOV_L()
{
	SetNovBeltBonus(FALSE, NovBelt_Equipped);
};
...
{
	SetKDFBeltBonus(TRUE, KDFBelt_Equipped);
};

func void UnEquip_ITAR_KDF_L()
{
	SetKDFBeltBonus(False, KDFBelt_Equipped);
};
...
{
	SetLeatherBeltBonus(TRUE, LeatherBelt_Equipped);
};

func void UnEquip_ITAR_Leather_L()
{
	SetLeatherBeltBonus(FALSE, LeatherBelt_Equipped);
};
...
instance ITAR_Leather_Baby(C_Item)
{
	name = "Женский кожаный доспех";
	mainflag = ITEM_KAT_ARMOR;
	flags = 0;
	protection[PROT_EDGE] = 25;
	protection[PROT_BLUNT] = 25;
	...
	wear = WEAR_TORSO;
	visual = "ItAr_Leather_L.3ds";
	visual_change = "ARMOR_LEATHER_BABY0.asc";
	visual_skin = 0;
	material = MAT_LEATHER;
	on_equip = Equip_ITAR_Leather_Baby;
	on_unequip = UnEquip_ITAR_Leather_Baby;
	description = name;
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Point;
...
func void Equip_ITAR_Leather_Baby()
{
	SetLeatherBeltBonus(TRUE, LeatherBelt_Equipped);
	Mdl_RemoveOverlayMDS(self,"Humans_Babe.mds");
};

func void UnEquip_ITAR_Leather_Baby()
{
	SetLeatherBeltBonus(FALSE, LeatherBelt_Equipped);
