...
class zCCamera {
    ...
    //var int zTViewportData    vpData;
        var int xmin;               //int           // верхн€€ права€
        var int ymin;               //int         
        var int xdim;               //int           
        var int ydim;               //int         
        var int xminFloat;          //zVALUE        // верхн€€ лева€
        var int yminFloat;          //zVALUE    
        var int xmaxFloat;          //zVALUE        // нижн€€ права€
    ...
    */
    ...
    // Ёффекты на экране:	//NS: гашение, окрашивание, текстура
