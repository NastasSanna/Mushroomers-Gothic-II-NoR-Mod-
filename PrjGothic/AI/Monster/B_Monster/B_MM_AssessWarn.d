...
func void B_MM_AssessWarn()
{
	...
	if(Npc_IsInState(self,ZS_MM_Attack))
	{
		if(C_PredatorFoundPrey(self,other) && (!HasFlags(self.aivar[AIV_MM_Behaviour], BEHAV_AttackPriority)))
		{
			Npc_ClearAIQueue(self);
			Npc_SetTarget(self,other);
		}
	...
	if((self.guild == other.guild) && (HasFlags(self.aivar[AIV_MM_Behaviour], BEHAV_Packhunter)))
	{
