...
instance MENUITEM_SAVE_SLOT1(C_MENU_ITEM_DEF)
{
	...
	text[0] = "неизвестно";
	text[1] = "слот 1 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT2(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 2 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT3(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 3 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT4(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 4 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT5(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 5 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT6(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 6 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT7(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 7 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT8(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 8 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT9(C_MENU_ITEM_DEF)
{
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 9 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT10(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 10 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT11(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 11 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT12(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 12 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT13(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 13 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT14(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 14 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT15(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 15 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT16(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 16 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT17(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 17 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT18(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 18 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT19(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 19 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT20(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "неизвестно";
	text[1] = "слот 20 - чтобы использовать этот слот, нажмите RETURN и введите имя";
	posx = SAVEGAME_X1;
...
{
	text[0] = "неизвестно";
	text[1] = "слот 1 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (0 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "неизвестно";
	text[1] = "слот 2 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (1 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "неизвестно";
	text[1] = "слот 3 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (2 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "неизвестно";
	text[1] = "слот 4 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (3 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "неизвестно";
	text[1] = "слот 5 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (4 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "неизвестно";
	text[1] = "слот 6 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (5 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "неизвестно";
	text[1] = "слот 7 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (6 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "слот 8 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (7 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "слот 9 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (8 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "слот 10 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (9 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "слот 11 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (10 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "слот 12 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (11 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "слот 13 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (12 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "слот 14 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (13 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "слот 15 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (14 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "слот 16 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (15 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "слот 17 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (16 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "слот 18 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (17 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "слот 19 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (18 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "слот 20 - нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (19 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
instance MENUITEM_LOAD_SLOT0(C_MENU_ITEM_DEF)
{
	...
	text[1] = "нажмите RETURN, чтобы загрузить это сохранение";
	posx = SAVEGAME_X1;
