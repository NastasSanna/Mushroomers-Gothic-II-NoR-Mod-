...
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Длина субтитров";
	text[1] = "Задать длительность субтитров без озвучки, мс/симв.";
	posx = 1000;
...
{
	type = MENU_ITEM_INPUT;
	text[1] = "Для вступления этой настройки в силу необходимо перезапустить игру.";
	posx = CTRL_SP1_2;
