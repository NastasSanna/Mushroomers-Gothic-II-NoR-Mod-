...
instance DRUNK(CFX_BASE_PROTO)
{
	visname_s = "time.slw";
	userstring[0] = "0.8";	//ÏË
	userstring[1] = "0.5";	//√√ ÏÂ‰ÎÂÌÌÂÂ ÏË‡
	emfxtriggerdelay = 4;
	emfxcreate_s = "DRUNK_CHILD";	//‰ÓÔ. ˝ÙÙÂÍÚ
	emtrjoriginnode = "BIP01";
	emfxlifespan = 80;
};
...
{
	visname_s = "morph.fov";
	userstring[0] = "1.5";	//‡ÏÔÎËÚÛ‰‡
	userstring[1] = "0.6";	//ÒÍÓÓÒÚ¸
	userstring[2] = "120";	//Û„ÓÎ X ?
	userstring[3] = "90";	//Û„ÓÎ Y ?
	emfxtriggerdelay = 2;
	emfxlifespan = 80;
};
